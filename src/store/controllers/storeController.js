...
exports.createStoreCategory = async (req, res, next) => {
  try {
    const storeCategory = await storeService.createStoreCategory(
      req.user.id,
      req.params.storeId,
      req.body
    );
...
exports.updateStoreCategory = async (req, res, next) => {
  try {
    const storeCategory = await storeService.updateStoreCategoryById(
      req.user.id,
      req.params.storeId,
...
exports.getStoreCategory = async (req, res, next) => {
  try {
    ...
    const storeCategory = await storeService.getStoreCategoryById(
      req.params.storeId,
      req.params.categoryId
    );
    res.json(storeCategory);
